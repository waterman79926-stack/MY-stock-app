...
if stock_list and stock_list[0] != "":
    ...
    try:
        ...
        if df.empty:
            ...
            col1.metric("今日收盤價", f"${current_price:.2f}", f"{price_change:+.2f} ({price_change_pct:+.2f}%)")
            ...
            fig.add_trace(gr.Candlestick(
                ...
                name='K線', increasing_line_color='red', increasing_fill_color='red',
